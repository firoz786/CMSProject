 ...
 */
public class JSPProfileUpdateAction extends HttpServlet {

	public static final Logger LOGGER = Logger.getLogger(JSPProfileUpdateAction.class);
    /**
     ...
     */
    private void getProfileDetails(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (new JSPProfileUpdateFacade().getmemberCredentials(jSPProfileUpdateTO)) {
                ...
                requestDispatcher = request.getRequestDispatcher("ProfileUpdate.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        getProfileDetails(request, response);
    }
